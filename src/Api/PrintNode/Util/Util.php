...
namespace Xslain\Printing\Api\PrintNode\Util;
...
abstract class Util
{
     ...
     * @param  null|class-string<\Xslain\Printing\Api\PrintNode\PrintNodeObject>  $expectedResource  the expected resource class for the response
     */
