 ...
 * @property-read \Xslain\Printing\Api\PrintNode\Resources\Printer $printer The printer the job was sent to
...
class PrintJob extends PrintNodeApiResource
{
    ...
    public static function create(array|PendingPrintJob $params, null|array|RequestOptions $opts = null): static
    {
        ...
        /** @var \Xslain\Printing\Api\PrintNode\PrintNodeApiResponse $response */
