...
use Xslain\Printing\Api\Cups\Exceptions\TypeNotSpecified;
...
abstract class AttributeGroup implements Arrayable, ArrayAccess, JsonSerializable
{
    ...
    /**
     * @return array<string, \Xslain\Printing\Api\Cups\Type|array<int, \Xslain\Printing\Api\Cups\Type>>
     */
     ...
     *
     * @param  array<int, \Xslain\Printing\Api\Cups\Type>  $values
     */
