...
interface PrintNodeClientInterface extends BasePrintNodeClientInterface
{
     ...
     * @param  null|class-string<\Xslain\Printing\Api\PrintNode\PrintNodeObject>  $expectedResource  the object we should map the response into
     */
     ...
     * @param  array  $params  the parameters of the request
     * @param  array|RequestOptions  $opts  the special modifiers of the request
     * @param  null|class-string<\Xslain\Printing\Api\PrintNode\PrintNodeObject>  $expectedResource  the object we should map each resource into
     */
